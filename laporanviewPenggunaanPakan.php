...
if(isset($_POST['btnTampil'])) {
	...
	$SqlPeriode = " where Tanggal BETWEEN '".$tglAwal."' AND '".$tglAkhir."'";
		...
		die('Tanggal tidak boleh lebih dari hari ini');
	}
...
<head>
	...
	<title> Data Penggunaan Pakan </title>
...
<main class="page shopping-cart-page">
    <div class="container-fluid">
    	<br>
        <h3 class="text-dark mb-4">Data Penggunaan Pakan</h3>
        ...
        <tbody>
		<?php
		$Sql 	= "SELECT * FROM penggunaanpakan $SqlPeriode";								
        ...
        <tr>						
			...
			<td><?php echo $myData['KodePenggunaanPakan'];?></td>
			<td><?php echo $myData['Tanggal'];?></td>
			<td><?php echo $myData['TotalPenggunaan'];?></td>
        </tr>
		<?php
		} $nomor++;
		?>
	...
	<div class="row">
		  <div class="col-lg-3">
		  <a href="laporancetakpenggunaanpakan.php?awal=<?php echo $tglAwal; ?>&&akhir=<?php echo $tglAkhir; ?>" target="_blank" alt="Edit Data" class="btn btn-primary">Cetak Laporan</a>
		  </div>
	 </div>           
                    </div>
                </div>
