...
include "INCLUDES/confiig.php";
	...
	$query =mysqli_query($connection,"SELECT max(kodePersediaan) as maxKode FROM persediaan");
    ...
    mysqli_query($connection,"insert into Persediaan values ('$kodejadi', '$namaPersediaan', '$stdpro', '$satuan','$stok')");
    header("location:PersediaanView.php");
...
<head>
	...
	<div class="col-sm-1"></div>
  	...
  	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4">Input Persediaan Bahan</h1>
		</div>
	</div>
   	...
   	<form method="POST">
	   	...
	   	<div class="form-group row">
		    <label for="namaPersediaan" class="col-sm-2 col-form-label">Nama Persediaan</label>
			    <div class="col-sm-10">
			      ...
			      name="inputnama"placeholder="Nama Persediaan">
			    </div>
	 	</div>
	 	...
	 	<div class="form-group row">
		    <label for="stdpro" class="col-sm-2 col-form-label">Standar Protein</label>
			    <div class="col-sm-10">
			      <input type="number" class="form-control" id="stdpro"
			      name="inputstdpro"placeholder="Standar Protein">
			    </div>
	 	</div>
	 	...
	 	<div class="form-group row">
		    <label for="Stok" class="col-sm-2 col-form-label">Stok</label>
			    <div class="col-sm-10">
			      ...
			      name="inputStok"placeholder="Stok">
			    </div>
	 	</div>
